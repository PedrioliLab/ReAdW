...
const char *getCGIBin() {
   return DEFAULT_CGI_BIN;
}
const char *getCometLinksDir() {
   return DEFAULT_COMETLINKSDIR;
}
const char *getHelpDir() {
   return DEFAULT_HELP_DIR;
}

const char *getHTMLDir() {
